...
import { TransmuterMock } from "../typechain/TransmuterMock";
import { TransmuterBuffer } from "../typechain/TransmuterBuffer";
import {
  YearnTokenAdapter,
  TestERC20,
  TestYieldToken,
  ...
  describe("exchange()", () => {
    ...
    describe("local balance < available flow", () => {
      ...
      it("pulls some funds from the alchemist", async () => {
        ...
        console.log(formatEther(beforeBal), formatEther(afterBal));
